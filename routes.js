...
router.post('/goods', cors(), (req, res) => {
    console.log("entering goods function in functions ");
    const Rice = req.body.rice;
    console.log(rice-stock);
    const Wheat = req.body.wheat;
    console.log(wheat-stock);
    const Kerosene = req.body.kerosene;
    console.log(kerosene-stock);
   
   
    goods
        .goods(Rice,Wheat,Kerosene)
        .then(result => {  
